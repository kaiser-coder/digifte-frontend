  ...
  <div>
    <div class="featuredItem">
      ...
      <div class="featuredContainer">
        ...
        <br />
        <q-btn color="secondary" @click="fixed = true" label="Créer leçon" />
        <br />
        <br />
        <q-markup-table>
          <thead>
          ...
          <tbody>
            <tr
              v-for="(lesson, index) in lessonsDetails"
              :key="index"
              @click="getLessonsDetails(course_id)"
            >
              ...
              <td class="text-center">
                <q-btn
                  color="brown-5"
                  v-if="lesson.zoom_url"
                  @click="handleLaunchMeeting(lesson.zoom_url)"
...
export default {
  ...
  methods: {
    ...
    getLessonsDetails(course_id) {
      ...
      axios
        .get(`/api/lessons/courses/${course_id}`, {
    ...
    submitFormLesson() {
      ...
      const formLesson = {
        name: this.name,
        zoom_url:
          'https://us04web.zoom.us/j/72256795915?pwd=9xg_QI3ayFPv3S8RaWaI-_Keh6gGM2.1',
        start_date: date,
    ...
    submitFormMeeting() {
      ...
      var date_zoom =
        this.start_date_meet + 'T' + this.start_time_meet + ':00Z';
